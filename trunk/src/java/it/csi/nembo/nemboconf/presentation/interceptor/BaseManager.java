package TOBECONFIG.nembo.nemboconf.presentation.interceptor;
...
import TOBECONFIG.nembo.nemboconf.exception.InterceptorException;
...
public abstract class BaseManager
{
      ...
      throws InterceptorException
  {
    ...
    forward(NemboConstants.PAGE.JSP.ERROR.INTERNAL_ERROR, request,
        response);
  }
