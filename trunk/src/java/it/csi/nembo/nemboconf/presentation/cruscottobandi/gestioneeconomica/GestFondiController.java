...
import TOBECONFIG.nembo.nemboconf.business.IEconomieEJB;
...
import TOBECONFIG.papua.papuaserv.dto.gestioneutenti.UtenteLogin;
    ...
    if (errors.isEmpty())
    {
      ...
      for (MisuraDTO m : elencoLivelli)
        for (SottoMisuraDTO s : m.getElenco())
          for (TOBECONFIG.nembo.nemboconf.dto.pianofinanziario.TipoOperazioneDTO t : s
              .getElenco())
