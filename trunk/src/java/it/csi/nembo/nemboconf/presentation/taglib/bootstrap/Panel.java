...
public class Panel extends Titled
{
      ...
      String contentID)
  {
    ...
    {
      if (TYPE.DEFAULT.toString().equals(type))
      {
        sb.append("\n<div class=\"panel-default \">");
      }
      else
        if (TYPE.HEADING.toString().equals(type))
        {
    ...
    if (collapsible)
    {
      ...
      if (startOpened)
      {
        sb.append("<i class=\"icon icon-minus-sign\" ></i>&nbsp;");
      }
      else
      {
        sb.append("<i class=\"icon icon-plus-sign\" ></i>&nbsp;");
      }
    }
    sb.append(title);
    if (collapsible)
