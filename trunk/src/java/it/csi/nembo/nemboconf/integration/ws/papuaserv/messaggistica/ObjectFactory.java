 ...
 * TOBECONFIG.nembo.nemboconf.integration.ws.papuaserv.messaggistica package.
 * <p>
...
public class ObjectFactory
{
  ...
  private final static QName _VerificaLogout_QNAME                   = new QName(
      "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/",
      "verificaLogout");
   ...
   * TOBECONFIG.nembo.nemboconf.integration.ws.papuaserv.messaggistica
   * 
   */
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "verificaLogout")
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "getAllegato")
   ...
   * }{@code <}{@link GetAllegatoResponse }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "getAllegatoResponse")
  ...
  /**
   * Create an instance of {@link JAXBElement
   * }{@code <}{@link ConfermaLetturaMessaggio }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "confermaLetturaMessaggio")
  ...
  /**
   * Create an instance of {@link JAXBElement
   * }{@code <}{@link GetDettagliMessaggioResponse }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "getDettagliMessaggioResponse")
  ...
  /**
   * Create an instance of {@link JAXBElement
   * }{@code <}{@link VerificaLogoutResponse }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "verificaLogoutResponse")
  ...
  /**
   * Create an instance of {@link JAXBElement
   * }{@code <}{@link ConfermaLetturaMessaggioResponse }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "confermaLetturaMessaggioResponse")
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "LogoutException")
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "InternalException")
  ...
  /**
   * Create an instance of {@link JAXBElement
   * }{@code <}{@link GetDettagliMessaggio }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "getDettagliMessaggio")
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "getListaMessaggi")
  ...
  /**
   * Create an instance of {@link JAXBElement
   * }{@code <}{@link GetListaMessaggiResponse }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://papuaserv.webservice.business.papuaserv.papua.TOBECONFIG/", name = "getListaMessaggiResponse")
