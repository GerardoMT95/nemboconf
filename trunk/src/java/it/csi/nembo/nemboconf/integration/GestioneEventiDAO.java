...
public class GestioneEventiDAO extends BaseDAO
{
  ...
  public List<DecodificaDTO<Long>> getListEventoCalamitoso(long idCategoriaEvento, long[] arrayIdEventoCalamitoso) throws InternalUnexpectedException {
		...
		final String QUERY = 
				...
				"    'Data evento: ' || TO_CHAR(EC.DATA_EVENTO, 'DD/MM/YYYY') || ' - ' || EC.DESCRIZIONE AS DESCRIZIONE,									\r\n" +
	...
	throws InternalUnexpectedException
{
    ...
    final String INSERT =
    		"INSERT INTO  NEMBO_D_EVENTO_CALAMITOSO									\r\n" + 
    		"    (																	\r\n" + 
			...
			;
    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
    long seqNemboDEventoCalamitoso = 0;
    try
    {
      seqNemboDEventoCalamitoso = getNextSequenceValue("SEQ_NEMBO_D_EVENTO_CALAMITOSO");
      mapParameterSource.addValue("ID_EVENTO_CALAMITOSO", seqNemboDEventoCalamitoso, Types.NUMERIC);
    ...
    catch (Throwable t)
    {
      InternalUnexpectedException e = new InternalUnexpectedException(t,
          new LogParameter[]
          {
              new LogParameter("ID_EVENTO_CALAMITOSO", seqNemboDEventoCalamitoso),
    ...
    return seqNemboDEventoCalamitoso;	
}

	public long lockEventoCalamitoso(long idEventoCalamitoso)
	{
		final String QUERY = " SELECT 1 FROM NEMBO_D_EVENTO_CALAMITOSO WHERE ID_EVENTO_CALAMITOSO = :ID_EVENTO_CALAMITOSO FOR UPDATE ";
		MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
...
public long getNBandiAssociatiAdEvento(long idEventoCalamitoso) throws InternalUnexpectedException
{
	...
	public long updateEventoCalamitoso(EventiDTO evento) throws InternalUnexpectedException
	{
	    ...
	    final String INSERT =
	    		"UPDATE NEMBO_D_EVENTO_CALAMITOSO									\r\n" + 
	    		"    SET																	\r\n" + 
