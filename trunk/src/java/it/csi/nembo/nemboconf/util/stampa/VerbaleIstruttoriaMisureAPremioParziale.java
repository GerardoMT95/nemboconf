...
public class VerbaleIstruttoriaMisureAPremioParziale extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbaleIstruttoriaMisureAPremioParziale()
  {
    super();
  }

  public VerbaleIstruttoriaMisureAPremioParziale(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_verbaleIstruttoriaDomandaPremio-PN";
  }
  ...
  {
    return BASE_RIF_ADOBE + "verbaleIstruttoriaDomandaPremio-PN.xdp";
  }
