...
public class ComunicazioneEsitoIstruttoriaMisureAPremioParziale extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public ComunicazioneEsitoIstruttoriaMisureAPremioParziale()
  {
    super();
  }

  public ComunicazioneEsitoIstruttoriaMisureAPremioParziale(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_ammissioneParzFinPremio";
  }
  ...
  {
    return BASE_RIF_ADOBE + "ammissioneParzPremio.xdp";
  }

  @Override
  public String getDefaultFileName()
  {
    return "Ammissione parziale finanziamento misure a premio.pdf";
  }
