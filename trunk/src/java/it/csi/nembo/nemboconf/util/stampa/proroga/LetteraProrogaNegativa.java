...
public class LetteraProrogaNegativa extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public LetteraProrogaNegativa()
  {
    super();
  }

  public LetteraProrogaNegativa(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_LetteraProrogaNegativo";
  }
