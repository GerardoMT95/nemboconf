...
public class VerbalePostIstruttoriaPremioParziale extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbalePostIstruttoriaPremioParziale()
  {
    super();
  }

  public VerbalePostIstruttoriaPremioParziale(String cuNameRef)
  {
    super();
