...
public class LetteraPostIstruttoriaPremioPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";
  private String             cuNameRef = null;

  public LetteraPostIstruttoriaPremioPositivo()
  {
    super();
  }

  public LetteraPostIstruttoriaPremioPositivo(String cuNameRef)
  {
    super();
