package TOBECONFIG.nembo.nemboconf.util.stampa.misurepremio.postistruttoria;
...
public class VerbalePostIstruttoriaPremioPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbalePostIstruttoriaPremioPositivo()
  {
    super();
  }

  public VerbalePostIstruttoriaPremioPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_VerbalePostIstruttoria";
  }
  ...
  {
    return BASE_RIF_ADOBE + "verbalePostIstr.xdp";
  }

  @Override
  public String getDefaultFileName()
  {
    return "Verbale post istruttoria domanda premio.pdf";
  }
