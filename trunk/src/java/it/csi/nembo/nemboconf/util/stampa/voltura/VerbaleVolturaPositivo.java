package TOBECONFIG.nembo.nemboconf.util.stampa.voltura;
...
public class VerbaleVolturaPositivo extends Stampa
{
  ...
  public byte[] genera(long idBandoOggetto, String cuName) throws Exception
  {
    if (cuNameRef != null)
    {
      ...
      if (!cuName
          .endsWith("-" + NemboConstants.ESITO.TIPO.PARZIALMENTE_POSITIVO))
      {
        cuName += "-" + NemboConstants.ESITO.TIPO.PARZIALMENTE_POSITIVO;
      }
  ...
  {
    return "nembo_VerbaleVolturaPositivo";
  }
