...
public class VerbalePostIstruttoriaPremioNegativo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbalePostIstruttoriaPremioNegativo()
  {
    super();
  }

  public VerbalePostIstruttoriaPremioNegativo(String cuNameRef)
  {
    super();
