package TOBECONFIG.nembo.nemboconf.util.stampa.proroga;
...
public class LetteraProrogaPositiva extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public LetteraProrogaPositiva()
  {
    super();
  }

  public LetteraProrogaPositiva(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_LetteraProrogaPositivo";
  }
  ...
  {
    return "ComunicazioneProroga.pdf";
  }
