...
public class ComunicazioneEsitoIstruttoriaMisureAPremioNegativo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public ComunicazioneEsitoIstruttoriaMisureAPremioNegativo()
  {
    super();
  }

  public ComunicazioneEsitoIstruttoriaMisureAPremioNegativo(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_NonAmmFinanziamentoPremio";
  }
  ...
  {
    return BASE_RIF_ADOBE + "NonAmmissionePremio.xdp";
  }

  @Override
  public String getDefaultFileName()
  {
    return "Non ammissione finanziamento misure a premio.pdf";
  }
