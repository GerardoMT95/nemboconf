...
public class ComunicazioneEsitoIstruttoriaMisureAPremioPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public ComunicazioneEsitoIstruttoriaMisureAPremioPositivo()
  {
    super();
  }

  public ComunicazioneEsitoIstruttoriaMisureAPremioPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_ammissioneFinanziamentoPremio";
  }
  ...
  {
    return BASE_RIF_ADOBE + "ammissionePremio.xdp";
  }

  @Override
  public String getDefaultFileName()
  {
    return "Ammissione finanziamento misure a premio.pdf";
  }
