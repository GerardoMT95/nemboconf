...
public class VerbaleIstruttoriaMisureAPremioPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbaleIstruttoriaMisureAPremioPositivo()
  {
    super();
  }

  public VerbaleIstruttoriaMisureAPremioPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_verbaleIstruttoriaDomandaPremio-P";
  }
  ...
  {
    return BASE_RIF_ADOBE + "verbaleIstruttoriaDomandaPremio-P.xdp";
  }
