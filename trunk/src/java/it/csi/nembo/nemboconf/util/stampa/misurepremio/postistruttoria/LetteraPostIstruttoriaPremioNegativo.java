...
public class LetteraPostIstruttoriaPremioNegativo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";
  private String             cuNameRef = null;

  public LetteraPostIstruttoriaPremioNegativo()
  {
    super();
  }

  public LetteraPostIstruttoriaPremioNegativo(String cuNameRef)
  {
    super();
  ...
  {
    return "nembo_PreavvRigettoPostIstruttoria";
  }
  ...
  {
    return BASE_RIF_ADOBE + "preavvisoPostIstr.xdp";
  }
  ...
  {
    return "PreavvisoRigettoPostIstr.pdf";
  }
}
